...
# MAGIC
# MAGIC ------------------------------------------------
# MAGIC ##### To ingest data to a Volume in DataBricks  with can go different ways:
# MAGIC
# MAGIC 1 By uploading a file from the computer 
# MAGIC
# MAGIC 2 By downloading a file from a GitHub repository
# MAGIC
# MAGIC 3 By connecting to a cloud service(AWS, Azure, etc.)
# MAGIC
# MAGIC ------------------------------------------------
# MAGIC ------------------------------------------------
# MAGIC ##### To ingest data from a Github account follow teh next notebook 
# MAGIC ------------------------------------------------
# MAGIC
# MAGIC    - See Folder  CH02 Setup. 
...
# MAGIC -     a method clean_ingest_data("spark_programmingHBL/data", "spark_programmingHBL/data") 
# MAGIC that would pull the datsets from a GitHub account and will import it to the volume we created.
# MAGIC
# MAGIC The GitHub account must have the repository and the directories/folders with the data that will be downloaded from there.
# MAGIC ###### Repository: --> scholarnest_datasets
# MAGIC ###### Directory:  --> spark_programmingHBL
# MAGIC ###### Sub-directory: --> data
# MAGIC ###### file:      --> diamonds.json
# MAGIC ###### Full path: --> scholarnest_datasets/spark_programmingHBL/data/diamonds.json
# MAGIC
# MAGIC .
# MAGIC
# MAGIC
