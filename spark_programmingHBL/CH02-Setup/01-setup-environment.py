...
# MAGIC %md
# MAGIC ####2. Import data ingestion utility to our volume
...
DL = DataLoader()
DL.clean_ingest_data("spark_programmingHBL/data", "spark_programmingHBL/data")
...
# MAGIC SELECT * FROM json.`/Volumes/dev/spark_db/datasets/spark_programmingHBL/data/diamonds.json`
